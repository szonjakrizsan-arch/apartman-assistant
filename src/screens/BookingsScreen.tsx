...
const FILTERS: FilterConfig[] = [
  { id: "all",       label: "Mind",   inactiveBg: "bg-surface-card", inactiveText: "text-text-secondary", inactiveRing: "ring-border-subtle",    inactiveBadgeBg: "bg-border-subtle/70",    inactiveBadgeText: "text-text-secondary", activeBg: "bg-surface-raised", activeText: "text-text-primary", activeRing: "ring-border-subtle",   activeBadgeBg: "bg-border-subtle",     activeBadgeText: "text-text-primary" },
  { id: "arriving",  label: "Érkezik",  inactiveBg: "bg-[#dc84601e]",  inactiveText: "text-[#dc8460]",      inactiveRing: "ring-[#dc846035]",      inactiveBadgeBg: "bg-[#dc846032]",         inactiveBadgeText: "text-[#dc8460]",      activeBg: "bg-[#dc846030]",    activeText: "text-[#dc8460]",    activeRing: "ring-[#dc846055]", activeBadgeBg: "bg-[#dc846050]",       activeBadgeText: "text-[#dc8460]" },
  ...
  { id: "departing", label: "Távozik",  inactiveBg: "bg-[#56b0bb1e]",  inactiveText: "text-[#56b0bb]",      inactiveRing: "ring-[#56b0bb35]",      inactiveBadgeBg: "bg-[#56b0bb32]",         inactiveBadgeText: "text-[#56b0bb]",      activeBg: "bg-[#56b0bb30]",    activeText: "text-[#56b0bb]",    activeRing: "ring-[#56b0bb55]", activeBadgeBg: "bg-[#56b0bb50]",       activeBadgeText: "text-[#56b0bb]" },
];
